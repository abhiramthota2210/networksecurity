...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        ...
        '''
        It initialises a KNN Imputer object with the paramters specified in th training_pipeline.py file 
        and returns a Pipeline object with the KNN Imputer object as the step
        ...
        '''
        logging.info(
            "Entered get_data_transformer_object method of Transforamation class"
            
        )       
        try:
            imputer:KNNImputer=KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS)
            logging.info(f"Initialise inputer with{DATA_TRANSFORMATION_IMPUTER_PARAMS}")
