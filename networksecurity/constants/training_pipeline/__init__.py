...
DATA_INGESTION_DATABASE_NAME: str = "Abhiram"
DATABASE_INGESTION_DIR_NAME: str ="data_ingestion"
DATABASE_INGESTION_FEATURE_STORE_DIR: str ="feature_store"
DATABASE_INGESTION_INGESTED_DIR: str = "ingested"
DATABASE_INGESTION_TRAIN_TEST_SPLIT_RATIO: float=0.2
...
"""
DATA_TRANSFORMATION_DIR_NAME:str="daat_transformation"
